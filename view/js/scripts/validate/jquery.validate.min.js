...
(function (c) {
    ...
    c.extend(c.validator, {defaults: {messages: {}, groups: {}, rules: {}, errorClass: "error",
        ...
        c.extend(c.validator.defaults,
            a)
    }, messages: {required: "Este campo es requerido.", remote: "Please fix this field.", email: "Debe entrar una direcci&#243;n email v&#225;lida.", url: "Please enter a valid URL.", date: "Please enter a valid date.", dateISO: "Please enter a valid date (ISO).", number: "Please enter a valid number.", digits: "Por favor solo N&#250;meros.", creditcard: "Please enter a valid credit card number.", equalTo: "Debe entrar el mismo valor.", accept: "Please enter a value with a valid extension.", maxlength: c.validator.format("Es requerido no m&#225;s de {0} caracteres."),
        minlength: c.validator.format("Son requeridos m&#225;s de {0} caracteres."), rangelength: c.validator.format("Please enter a value between {0} and {1} characters long."), range: c.validator.format("Please enter a value between {0} and {1}."), max: c.validator.format("Por favor entre un valor menor o igual a {0}."), min: c.validator.format("Por favor entre un valor mayor o igual a {0}.")}, autoCreateRanges: false, prototype: {init: function () {
        function a(e) {
