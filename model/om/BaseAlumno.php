...
abstract class BaseAlumno extends BaseObject implements Persistent
{
    ...
    public function setIduser($v)
    {
        ...
        if ($this->iduser !== $v) {
            $this->iduser = $v;
            $this->modifiedColumns[] = AlumnoPeer::IDUSER;
        }
    ...
    public function setIdprofesor($v)
    {
        ...
        if ($this->idprofesor !== $v) {
            $this->idprofesor = $v;
            $this->modifiedColumns[] = AlumnoPeer::IDPROFESOR;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->idprofesor = ($row[$startcol + 2] !== null) ? (int)$row[$startcol + 2] : null;
            $this->resetModified();
            ...
            return $startcol + 3; // 3 = AlumnoPeer::NUM_COLUMNS - AlumnoPeer::NUM_LAZY_LOAD_COLUMNS).
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->isModified()) {
                if ($this->isNew()) {
                    ...
                    if ($criteria->keyContainsValue(AlumnoPeer::ID)) {
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) $this->setIdprofesor($arr[$keys[2]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AlumnoPeer::IDUSER)) $criteria->add(AlumnoPeer::IDUSER, $this->iduser);
        if ($this->isColumnModified(AlumnoPeer::IDPROFESOR)) $criteria->add(AlumnoPeer::IDPROFESOR, $this->idprofesor);
