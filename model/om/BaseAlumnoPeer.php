...
abstract class BaseAlumnoPeer
{
    ...
    const CLASS_DEFAULT = 'mathgraph.Alumno';

    /** the related TableMap class for this table */
    const TM_CLASS = 'AlumnoTableMap';
    ...
    const IDUSER = 'alumno.IDUSER';

    /** the column name for the IDPROFESOR field */
    const IDPROFESOR = 'alumno.IDPROFESOR';
    ...
    private static $fieldNames = array(
        BasePeer::TYPE_PHPNAME => array('Id', 'Iduser', 'Idprofesor',),
        BasePeer::TYPE_STUDLYPHPNAME => array('id', 'iduser', 'idprofesor',),
        BasePeer::TYPE_COLNAME => array(self::ID, self::IDUSER, self::IDPROFESOR,),
        BasePeer::TYPE_RAW_COLNAME => array('ID', 'IDUSER', 'IDPROFESOR',),
        BasePeer::TYPE_FIELDNAME => array('id', 'iduser', 'idprofesor',),
    ...
    private static $fieldKeys = array(
        BasePeer::TYPE_PHPNAME => array('Id' => 0, 'Iduser' => 1, 'Idprofesor' => 2,),
        BasePeer::TYPE_STUDLYPHPNAME => array('id' => 0, 'iduser' => 1, 'idprofesor' => 2,),
        BasePeer::TYPE_COLNAME => array(self::ID => 0, self::IDUSER => 1, self::IDPROFESOR => 2,),
        BasePeer::TYPE_RAW_COLNAME => array('ID' => 0, 'IDUSER' => 1, 'IDPROFESOR' => 2,),
        BasePeer::TYPE_FIELDNAME => array('id' => 0, 'iduser' => 1, 'idprofesor' => 2,),
        BasePeer::TYPE_NUM => array(0, 1, 2,)
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(AlumnoPeer::IDUSER);
            $criteria->addSelectColumn(AlumnoPeer::IDPROFESOR);
        } else {
    ...
    /**
     * Method to invalidate the instance pool of all tables related to alumno
    ...
    public static function populateObjects(PDOStatement $stmt)
    {
        ...
        $cls = AlumnoPeer::getOMClass(false);
    ...
    {
        $key = AlumnoPeer::getPrimaryKeyHashFromRow($row, $startcol);
        if (null !== ($obj = AlumnoPeer::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $startcol, true); // rehydrate
            $col = $startcol + AlumnoPeer::NUM_COLUMNS;
        } else {
            $cls = AlumnoPeer::OM_CLASS;
            $obj = new $cls();
    ...
    {
        $dbMap = Propel::getDatabaseMap(BaseAlumnoPeer::DATABASE_NAME);
        if (!$dbMap->hasTable(BaseAlumnoPeer::TABLE_NAME)) {
    ...
    {
        return $withPrefix ? AlumnoPeer::CLASS_DEFAULT : AlumnoPeer::OM_CLASS;
    }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $value = $criteria->remove(AlumnoPeer::ID);
            if ($value) {
                $selectCriteria->add(AlumnoPeer::ID, $value, $comparison);
            } else {
                $selectCriteria->setPrimaryTableName(AlumnoPeer::TABLE_NAME);
            }
    ...
    public static function doDeleteAll($con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            $affectedRows += BasePeer::doDeleteAll(AlumnoPeer::TABLE_NAME, $con, AlumnoPeer::DATABASE_NAME);
            // Because this db requires some delete cascade/set null emulation, we have to
            // clear the cached instance *after* the emulation has happened (since
            // instances get re-added by the select statement contained therein).
            AlumnoPeer::clearInstancePool();
            AlumnoPeer::clearRelatedInstancePool();
            $con->commit();
            return $affectedRows;
        } catch (PropelException $e) {
            $con->rollBack();
    ...
    public static function doValidate(Alumno $obj, $cols = null)
    {
        ...
        return BasePeer::doValidate(AlumnoPeer::DATABASE_NAME, AlumnoPeer::TABLE_NAME, $columns);
    }
