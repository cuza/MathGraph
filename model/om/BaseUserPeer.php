...
abstract class BaseUserPeer
{
    ...
    const CLASS_DEFAULT = 'mathgraph.User';
    ...
    private static $fieldNames = array(
        BasePeer::TYPE_PHPNAME => array('Id', 'Nick', 'Pass', 'Name', 'Role',),
        BasePeer::TYPE_STUDLYPHPNAME => array('id', 'nick', 'pass', 'name', 'role',),
        BasePeer::TYPE_COLNAME => array(self::ID, self::NICK, self::PASS, self::NAME, self::ROLE,),
        BasePeer::TYPE_RAW_COLNAME => array('ID', 'NICK', 'PASS', 'NAME', 'ROLE',),
        BasePeer::TYPE_FIELDNAME => array('id', 'nick', 'pass', 'name', 'role',),
    ...
    private static $fieldKeys = array(
        BasePeer::TYPE_PHPNAME => array('Id' => 0, 'Nick' => 1, 'Pass' => 2, 'Name' => 3, 'Role' => 4,),
        BasePeer::TYPE_STUDLYPHPNAME => array('id' => 0, 'nick' => 1, 'pass' => 2, 'name' => 3, 'role' => 4,),
        BasePeer::TYPE_COLNAME => array(self::ID => 0, self::NICK => 1, self::PASS => 2, self::NAME => 3, self::ROLE => 4,),
        BasePeer::TYPE_RAW_COLNAME => array('ID' => 0, 'NICK' => 1, 'PASS' => 2, 'NAME' => 3, 'ROLE' => 4,),
        BasePeer::TYPE_FIELDNAME => array('id' => 0, 'nick' => 1, 'pass' => 2, 'name' => 3, 'role' => 4,),
        BasePeer::TYPE_NUM => array(0, 1, 2, 3, 4,)
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UserPeer::NICK);
